...
def guardrail_response() -> str:
    ...
    """
    return (
        "I can provide general information about Dipankar's Badminton Academy services. "
        "For specific advice or case-related guidance, please contact Dipankar's Badminton Academy directly."
    )